...
* ⚛️ [**Padrões de Arquitetura Frontend (React 19 / Vite / Tailwind)**](frontend/STANDARDS.md)
...
* **Backend:** Java 21, Spring Boot 3.4.2, Spring Data JPA, Spring Security, JJWT 0.12.6, H2 Database / PostgreSQL.
